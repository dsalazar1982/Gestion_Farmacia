        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="fnomina">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="dias_loborados;">Dias Laborados</label>
                        <div class="input-group col-sm-9" style="width:80%">
                            <input type="text" class="form-control" id="dias_loborados" name="dias_loborados" placeholder="Ingrese la cantidad de días laborados" value="">
                        </div>
                    </div>
