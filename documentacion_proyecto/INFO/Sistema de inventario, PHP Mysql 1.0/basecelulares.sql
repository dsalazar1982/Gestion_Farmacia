...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-09-2016 a las 15:52:29
...
(1, 'yond', '123456', 'yonathan', 'suarez', 'yond1994@gmail.com', 1),
(2, 'yond1994', '123456', 'YONATHAN DOS', 'SUAREZ', 'jond_14@hotmail.com', 2);
...
(8, 'TELEFONO', 'GALAXI S3', 'SAMSUNG', 0, 100000, 130000, '', 'USADO'),
...
--
ALTER TABLE `movimientos`
  MODIFY `id_movimientos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
