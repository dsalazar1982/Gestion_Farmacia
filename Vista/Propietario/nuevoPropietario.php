        ...
        <div class="panel-group"><div class="panel panel-primary">
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nombre_propietario" name="nombre_propietario" placeholder="Ingrese Nombres del propietario"
                            value = "">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="apellido_propietario" name="apellido_propietario" placeholder="Ingrese Apellidos propietario"
                            value = "" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="direccion_propietario" name="direccion_propietario" placeholder="Ingrese direccion propietario"
                            value = "">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="telefono_propietario" name="telefono_propietario" placeholder="Ingrese telefono propietario"
                            value = "">
                        </div>
                    </div>
...
<div class="form-group">        
   <div class="col-sm-offset-2 col-sm-10">
       <button type="button" id="actualizar" data-toggle="tooltip" title="Grabar Propietario" class="btn btn-primary">Grabar Propietario</button>
