...
<div id="presentacion">
    <div class="box-header">
        <h1 class="alert alert-success" role="alert">PRESENTACION DE MEDICAMENTOS</h1>
        <!--<i class="ion ion-clipboard"></i>-->
        <!-- tools box -->
        <div class="pull-right box-tools">
            <button class="btn btn-info btn-sm" id="nuevo" data-toggle="tooltip" title="Nueva presentacion"><i
