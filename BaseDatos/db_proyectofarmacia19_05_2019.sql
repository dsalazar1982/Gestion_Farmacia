...
INSERT INTO `tb_empleados` (`id_empleado`, `nombre_empleado`, `apellido_empleado`, `cargo_empleado`, `id_pais`, `id_ciudad`, `direccion_empleado`, `telefono_empleado`, `email_empleado`) VALUES
	(1144198853, 'Miguel Angel', 'Cerquera Rodriguez', 'Soporte y mantenimiento', 205, 76001, 'Cra 50 # 45 - 69', '3113074159', 'cerquera199627@hotmail.com'),
	(1144198854, 'Daniel Alberto', 'Salazar Erazo', 'Gerente', 205, 76001, 'Cra 51 # 58 - 89', '3124567898', 'dsalazar1982@gmail.com'),
	(1144198855, 'Stiven ', 'Arcila Pardo', 'Analista de software', 220, 2500, 'cra 150 # 15 - 45', '758669789', 'sarcilap@gmail.com'),
	(1144198856, 'Cristian', 'Moreno', 'Scrum master', 205, 5001, 'cra 62 # 45 - 96', '3102594781', 'morenoc225@gmail.com'),
	(1144198857, 'Brandon ', 'Machado Vargas', 'Secretario de defensa', 205, 11001, 'cra 45 # 89 - 90', '3024569812', 'brandonmachadovargas14@gmail.com');
...
INSERT INTO `tb_roles` (`id_rol`, `nombre_rol`, `update_at`) VALUES
	...
	(52, 'Empleado', '2019-05-19 21:44:21');
...
) ENGINE=InnoDB AUTO_INCREMENT=449 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

-- Volcando datos para la tabla db_proyectofarmacia.tb_rolesxpermisos: ~48 rows (aproximadamente)
...
-- Volcando datos para la tabla db_proyectofarmacia.tb_usuarios: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `tb_usuarios` DISABLE KEYS */;
INSERT INTO `tb_usuarios` (`id_usuario`, `nickname_usuario`, `clave_usuario`, `id_estado`, `id_rol`, `fechacreacion_usuario`) VALUES
	(27, 'miguel.cerquera', '$2y$12$safLKMF00OsugW14X4INA.QstlQ3a4d4INF4tNwq7XJA6O00/4.oy', 1, 48, '2019-05-19'),
	(28, 'daniel.salazar', '$2y$12$G.fGvLKF.Hog/TzMFawnNeVOPEOdabGBQ/zxxeIchBg9isyGa7uUa', 1, 48, '2019-05-19'),
	(29, 'steven.arcila', '$2y$12$95UrBd.vvjTdMDG.MVo36usqFCDnBx0KGgzoGM5y2P8WnCrTNeab6', 1, 48, '2019-05-19'),
	(30, 'cristian.moreno', '$2y$12$SZsUozxRc5yYNIDTf/TdQuKGtjoB1ZTMXVlG5s3Snftoq2DtBeKQS', 1, 48, '2019-05-19'),
	(31, 'brandon.vargas', '$2y$12$f4RaO2oZb3YQ3DUbUID7jey4F59hbZAQZ.dJIIeqXg2aG.b89V51u', 1, 48, '2019-05-19');
...
INSERT INTO `tb_usuarioxempleado` (`id_usuarioxempleado`, `id_empleado`, `id_usuario`, `update_at`) VALUES
	(17, 1144198853, 27, '2019-05-19 22:02:18'),
	(18, 1144198854, 28, '2019-05-19 22:02:47'),
	(19, 1144198855, 29, '2019-05-19 22:03:45'),
	(20, 1144198856, 30, '2019-05-19 22:04:19'),
	(21, 1144198857, 31, '2019-05-19 22:04:46');
